...
import com.example.gogreen.models.ModelReview;
...
public class AdapterReview extends RecyclerView.Adapter<com.example.gogreen.adapter.AdapterReview.HolderReview>{
    ...
    private void loadUserDetail(ModelReview modelReview, final HolderReview holder) {
        ...
        ref.child(uid).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                try {
                    Picasso.get().load(profileImage).placeholder(R.drawable.person).into(holder.profileIv);
