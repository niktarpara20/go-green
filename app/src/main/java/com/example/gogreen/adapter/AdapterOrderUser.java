...
import com.example.gogreen.activities.OrderDetailsUsersActivity;
...
public class AdapterOrderUser extends RecyclerView.Adapter<com.example.gogreen.adapter.AdapterOrderUser.HolderOrderUser>{
    ...
    @Override
     public void onBindViewHolder(@NonNull HolderOrderUser holder, int position) {
        ...
        String formatedDate = DateFormat.format("dd/MM/yyyy",calendar).toString(); //e.g. 31/03/2021
