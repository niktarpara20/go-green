...
public class EditProductActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        categoryTv = (TextView) findViewById(R.id.categoryEt);
        titleEt = (EditText) findViewById(R.id.titleEt);
        descriptionEt = (EditText) findViewById(R.id.descriptionEt);
        quantityEt = (EditText) findViewById(R.id.quantityEt);
        priceEt = (EditText) findViewById(R.id.priceEt);
        discountedPriceEt = (EditText) findViewById(R.id.discountedPriceEt);
        discountedNoteEt = (EditText) findViewById(R.id.discountedNoteEt);
        ...
        reference.child(firebaseAuth.getUid()).child("products").child(productId)
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        try {
                            Picasso.get().load(productIcon).placeholder(R.drawable.cartfigma).into(productIconIv);
                        }
                        catch (Exception e){
                            productIconIv.setBackgroundResource(R.drawable.cartfigma);
                        }
                    }
                    ...
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            if (uriTask.isSuccessful()){
                                //setup data in hashnap to update
                                HashMap<String, Object>hashMap=new HashMap<>();
                                hashMap.put("productTitle",""+ productTitle);
                                hashMap.put("productDescription",""+ productDescription);
                                hashMap.put("productCategory",""+ productCategory);
