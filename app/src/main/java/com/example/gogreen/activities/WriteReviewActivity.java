...
public class WriteReviewActivity extends AppCompatActivity {
    ...
    private void inputData() {
        ...
        hashMap.put("review", ""+ review); //e.g. Good Services
        ...
        ref.child(shopUid).child("Ratings").child(firebaseAuth.getUid()).updateChildren(hashMap)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        //review added to db
                        Toast.makeText(WriteReviewActivity.this,"Review Published Sucessfully...", Toast.LENGTH_SHORT).show();
                    }
                })
